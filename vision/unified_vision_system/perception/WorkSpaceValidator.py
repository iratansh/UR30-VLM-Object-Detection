...
This module provides workspace validation and safety checking for the UR30 robot:
...
class WorkspaceConfig:
    ...
    """
    x_limits: Tuple[float, float] = (-1.1, 1.1)
    y_limits: Tuple[float, float] = (-1.1, 1.1)
    z_limits: Tuple[float, float] = (0.1, 1.4)
...
class WorkspaceValidator:
    ...
    def __init__(self, config: Optional[WorkspaceConfig] = None, params: Optional[Dict] = None, debug_mode: bool = False):
        ...
        # Default workspace limits for UR30 (in meters)
    ...
    def is_reachable(self, x: float, y: float, z: float, safe_mode: bool = True) -> bool:
        ...
        MAX_REACH = 1.19  # UR30 max reach ~1190mm (a2 + a3 = 0.637 + 0.5037 + small offset)
    ...
    def get_nearest_valid_point(self, x: float, y: float, z: float) -> Tuple[float, float, float]:
        ...
        # Check and adjust radial distance against MAX_REACH (1.19m for UR30)
        # This assumes the origin (0,0,0) is the robot base.
        MAX_REACH = 1.19  # UR30 nominal reach (a2 + a3 = 0.637 + 0.5037 + small offset)
