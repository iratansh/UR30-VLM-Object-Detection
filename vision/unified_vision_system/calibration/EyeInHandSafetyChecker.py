"""
Safety and calibration verification script for eye-in-hand UR30 setup.
...
class EyeInHandSafetyChecker:
    """
    Safety checker for eye-in-hand configuration with RealSense on UR30.
    """
...
def main():
    ...
    print("\n" + "="*60)
    print("EYE-IN-HAND SAFETY CHECK FOR UR30")
    print("="*60)
